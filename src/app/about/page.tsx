		...
		<div className="flex flex-col">
			<div className="flex flex-col *:mx-auto overflow-clip text-background bg-foreground rounded-b-[4rem] lg:rounded-b-[8rem] pt-[2rem] relative" >
				<div className="flex flex-col *:mx-auto mt-24 z-10 lg:mt-52">
					...
					<div className="text-center text-[0.9rem] lg:text-[1rem] w-[20rem] lg:w-[60rem] py-8">Imagine a place where India’s rich cultural heritage is not just celebrated but actively woven into the daily fabric of campus life. This is the essence of Ek Bharat Shreshtha Bharat (EBSB), the cultural heartbeat of IITH. We breathe new life into the emotional connections within our campus community, celebrating our shared values and diverse backgrounds. At its heart, we embodies a powerful belief: our true strength shines through in the differences that unite us.</div>

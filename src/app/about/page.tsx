		...
		<div className="flex flex-col">
			<div className="flex flex-col *:mx-auto text-background bg-foreground rounded-b-[4rem] lg:rounded-b-[8rem] pt-[2rem] relative" >
				<div className="flex flex-col *:mx-auto mt-24 lg:mt-52">
					...
					<img src="/about/head.svg" className="px-16 mt-4" />
				</div>
				<img
					src="/watermark.svg"
			...
			<KeyThemesSection />
			<div className="flex flex-col lg:flex-row px-8 *:my-4 lg:*:my-auto mt-8 mb-20 lg:mb-24 *:px-6 *:py-10 *:rounded-[2.4rem] lg:*:rounded-3xl lg:*:mx-20 lg:h-[30rem] *:h-[14rem] lg:*:w-[24rem]">

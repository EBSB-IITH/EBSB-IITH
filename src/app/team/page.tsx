		...
		<div className="flex flex-col">
			<div className="flex overflow-x-clip flex-col mb-16 lg:mb-44 *:mx-auto text-background bg-foreground rounded-b-[3rem] lg:rounded-b-[8rem] pt-[2rem] relative" >
				...
				<div className="absolute self-center hidden lg:flex flex-row bottom-[-2rem] bg-white text-foreground text-xl px-6 py-6 rounded-[3rem] drop-shadow-lg *:mx-8">
					<div data-isfullteam={isFullTeam} onClick={() => { setIsFullTeam(true); setIsPR(true); setIsFinance(true); setIsDesign(true); setIsWeb(true); setIsMultimedia(true); setIsEvents(true) }} className="data-[isfullteam=true]:font-bold hover:cursor-pointer hover:font-semibold ">Full Team</div>
					<div data-ispr={isPR && !isFullTeam} onClick={() => { setIsFullTeam(false); setIsPR(true); setIsFinance(false); setIsDesign(false); setIsWeb(false); setIsMultimedia(false); setIsEvents(false) }} className="data-[ispr=true]:font-bold hover:cursor-pointer hover:font-semibold ">PR & Networking</div>
					<div data-isevents={isEvents && !isFullTeam} onClick={() => { setIsFullTeam(false); setIsPR(false); setIsFinance(false); setIsDesign(false); setIsWeb(false); setIsMultimedia(false); setIsEvents(true) }} className="data-[isevents=true]:font-bold hover:cursor-pointer hover:font-semibold ">Events</div>
					<div data-isfinance={isFinance && !isFullTeam} onClick={() => { setIsFullTeam(false); setIsPR(false); setIsFinance(true); setIsDesign(false); setIsWeb(false); setIsMultimedia(false); setIsEvents(false) }} className="data-[isfinance=true]:font-bold hover:cursor-pointer hover:font-semibold ">Finance & Equipment</div>
					<div data-isdesign={isDesign && !isFullTeam} onClick={() => { setIsFullTeam(false); setIsPR(false); setIsFinance(false); setIsDesign(true); setIsWeb(false); setIsMultimedia(false); setIsEvents(false) }} className="data-[isdesign=true]:font-bold hover:cursor-pointer hover:font-semibold ">Design</div>
					<div data-ismultimedia={isMultimedia && !isFullTeam} onClick={() => { setIsFullTeam(false); setIsPR(false); setIsFinance(false); setIsDesign(false); setIsWeb(false); setIsMultimedia(true); setIsEvents(false) }} className="data-[ismultimedia=true]:font-bold hover:cursor-pointer hover:font-semibold ">Multimedia</div>
					<div data-isweb={isWeb && !isFullTeam} onClick={() => { setIsFullTeam(false); setIsPR(false); setIsFinance(false); setIsDesign(false); setIsWeb(true); setIsMultimedia(false); setIsEvents(false) }} className="data-[isweb=true]:font-bold hover:cursor-pointer hover:font-semibold ">Web</div>
				</div>
			</div>

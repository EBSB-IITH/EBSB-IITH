...
export default function Page() {
	...
	return (
		<div className="flex flex-col">
			<div className="flex flex-col mb-16 lg:mb-44 *:mx-auto text-background bg-foreground rounded-b-[3rem] lg:rounded-b-[8rem] pt-[2rem] relative" >
				<div className="flex flex-col *:mx-auto mt-24 lg:mt-52">
					...
					<div className="text-center px-6 lg:px-auto lg:w-[36rem] py-4 lg:py-8 leading-snug mb-24 lg:mb-48">Get to know the talented individuals who form the backbone of our organization. Each member brings a unique set of skills, experiences, and passion, contributing to the synergy that drives our success.</div>
				</div>
				<img
					src="/watermark.svg"
			...
			<div data-dropdown={showDropdown} className="data-[dropdown=true]:bg-foreground data-[dropdown=true]:text-background data-[dropdown=true]:rounded-b-[0] relative lg:hidden flex flex-row px-6 py-2 mx-6 mb-14 border-foreground border-solid border-2 rounded-[3rem] " >
				...
				<div data-toshow={showDropdown} className="data-[toshow=true]:block hidden bg-foreground text-background absolute top-12 left-0 *:my-1 *:py-2 w-full rounded-b-[2rem] py-6 px-8 text-center " >

...
export default function Page() {
	return (
		<div className="flex flex-col">
			...
			<div className="flex flex-row px-24 mb-28">
				<div className="flex flex-col">
					<div className="font-bold text-[2rem]">MEET OUR DIRECTOR</div>
			...
			<div className="flex flex-col mx-24 py-12 border-black border-2 rounded-[1.4rem] ">
				...
				<div className="grid grid-cols-2 grid-rows-3 gap-4 pt-16 px-12 leading-snug">

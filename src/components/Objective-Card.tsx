...
export default function ObjectiveCard({ heading, description, imgSrc, type }: { heading: string, description: string, imgSrc: string, type: ObjectiveCardType }) {
	...
	if (type == ObjectiveCardType.Large) {
		return (
			...
			<div className={"flex flex-col bg-customGray h-[26rem] w-[18rem] rounded-3xl py-10 px-6 justify-between"}>
				<div>
		...
		return (
			...
			<div className={"flex flex-col bg-customGray h-[22rem] w-[16rem] rounded-3xl pt-10 pb-8 px-4 justify-between"}>
				<div>
					<div className="text-center font-bold text-2xl">{heading}</div>
					<div className="text-center mt-2">{description}</div>
				</div>
		...
		return (
			...
			<div className={"flex flex-col bg-customGray h-[14rem] w-[11rem] rounded-2xl pt-6 pb-4 px-3 justify-between"}>
				<div>

...
export function EthnicNight23() {
	return (
		<div className={outerDivStyle}>
			...
			<img src="/ethnicNight/23/man.svg" className="absolute right-[2rem] scale-[2.3] bottom-[8rem] z-10" />
			<img src="/ethnicNight/23/woman.svg" className="absolute left-[4rem] bottom-[8rem] scale-[2.3] z-10" />
